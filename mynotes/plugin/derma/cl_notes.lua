...
function PANEL:Populate(player, notes)
	self:SetTitle( player:Name().."'s Notes" );
	...
	function button.DoClick(button)
		...
		if (IsValid(player)) then
			Clockwork.datastream:Start( "EditNotes", { player, string.sub(textEntry:GetValue(), 0, 500) } );
		end;
